...
<html lang="ru">
    <head>
        ...
        <title><?= isset($article) ? escapeHtml($article['title']) . ' - ' : '' ?>Русский крест</title>
            ...
            <article class="article-detail">
                <div class="container">
                    <div class="breadcrumbs">
                        ...
                        <span>/</span>
                        <span><?= isset($article) ? escapeHtml($article['title']) : 'Загрузка...' ?></span>
                    </div>
                    ...
                    <div id="article-content">
                        <?php if (isset($error)): ?>
                            <div class="error-message">
                                ...
                                <p>Вернитесь на <a href="news.php">страницу пресс-центра</a></p>
                            </div>
                        <?php else: ?>
                            <div class="article-header">
                                <div class="article-meta">
                                    <span class="article-category"><?= escapeHtml(getCategoryName($article['category'])) ?></span>
                                    <span class="article-date"><?= escapeHtml(formatDate($article['published_at'])) ?></span>
                                </div>
                    ...
                    <div class="article-back">
                        <a href="news.php" class="btn btn--light-blue">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10 6L4 12M4 12L10 18M4 12H19" stroke="#375583" stroke-width="2" stroke-linecap="round"/>
                            </svg>
